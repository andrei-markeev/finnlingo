...
declare module Accounts {
  ...
  function _insertLoginToken(userId: string, token: string);
...
type FileInsertOptions = { 
  file: File,
  streams?: number | 'dynamic',
  chunkSize?: number | 'dynamic',
  allowWebWorkers?: boolean,
  onStart?: (err, fileData) => void,
  onUploaded?: (err, fileRef) => void,
  onAbort?: (fileData) => void,
  onProgress?: (progress: number, fileData) => void,
  onBeforeUpload?: (fileData) => void
};
type UploadHandler = { on: (event: string, handler: any) => void, start: () => void };
type FileCursor = { link: () => string };
...
declare module Meteor {
  ...
  function bindEnvironment(func: Function): void;
  /** utils **/
  ...
  class Files {
    ...
    insert(options: FileInsertOptions, autoStart?: boolean) : UploadHandler;
    findOne(selector: Mongo.Selector | string, options?: any) : FileCursor;
    remove(selector: Mongo.Selector | string, callback?: any) : Files;
  }
